...
The available designs in this package are for experiments where the number of parameters ranges from two to ten of types `"audze_eglais"`,  `"max_min_l1"`, or `"max_min_l2"`. 
